...
<head>
    ...
    <title>Information storage system</title>
                            ...
                            <div class="relative ml-3">
                                <div>
                                    <button type="button"
                                        ...
                                        <img class="h-8 w-8 rounded-full" src="img/BD_.png" alt="Firuz">
                                    </button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        <div class="flex-shrink-0">
                            <img class="h-10 w-10 rounded-full" src="img/BD_.png" alt="Firuz">
                        </div>
                        <div class="ml-3">
                            <div class="text-base font-medium leading-none text-white">Firuz Ahmmed</div>
                            <div class="text-sm font-medium leading-none text-gray-400">firuzahmed70@gmail.com</div>
                        </div>
                        <button type="button"
